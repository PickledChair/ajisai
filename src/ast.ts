...
export type AstProcNode = { nodeType: "proc", args: AstProcArgNode[], body: AstExprNode, envId: number };
...
export type AstBinaryNode = { nodeType: "binary", operator: BinOpKind, left: AstExprNode, right: AstExprNode };

export type UnOpKind = "-" | "!";
export type AstUnaryNode = { nodeType: "unary", operator: UnOpKind, operand: AstExprNode };

export type AstCallNode = { nodeType: "call", callee: AstExprNode, args: AstExprNode[] };
...
export type AstVariableNode = { nodeType: "variable", name: string, level: number, fromEnv: number, toEnv: number };
